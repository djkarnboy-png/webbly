  ...
  return (
    <section className="site-grid bg-[#f6f7fb] px-5 py-14 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-white p-6 shadow-[0_24px_60px_rgba(16,24,40,0.1)] sm:p-10">
        ...
        <h1 className="mt-3 text-4xl font-bold leading-tight text-slate-950">Create your marketplace account.</h1>
        <p className="mt-3 text-base leading-7 text-slate-600">Choose how you plan to use Webbly. You can update your public profile after signup.</p>
        <div className="mt-8">
          <SignupForm />
        </div>
