...
export default async function TemplatesPage({ searchParams }: TemplatesPageProps) {
  ...
  return (
    <>
      <section className="app-page border-b border-white/10 px-5 py-10 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-[1280px]">
          <div className="max-w-4xl">
            <p className="text-sm font-semibold uppercase text-blue-400">
              Template marketplace
            </p>
            <h1 className="mt-4 text-balance text-[38px] font-bold leading-[1.04] text-white sm:text-[54px]">
          ...
          <div className="mt-8 grid grid-cols-3 divide-x divide-white/10 border-y border-white/10 sm:mt-10">
            {[
      ...
      <section className="app-section-raised px-5 py-10 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-[1280px]">
          <MarketplaceBrowser
            templates={templates}
